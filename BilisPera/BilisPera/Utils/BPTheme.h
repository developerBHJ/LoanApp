...
#define kFontSemibold(size) [UIFont systemFontOfSize:kRatio(size) weight:UIFontWeightSemibold]
...
#define kColor_FFEDF5 [UIColor colorWithHex:0xFFEDF5]
#define kColor_333333 [UIColor colorWithHex:0x333333]
#define kColor_494949 [UIColor colorWithHex:0x494949]
#define kColor_FFE6F2 [UIColor colorWithHex:0xFFE6F2]
#define kColor_FBE7F2 [UIColor colorWithHex:0xFBE7F2]
#define kColor_351E29 [UIColor colorWithHex:0x351E29]
...
#define kColor_777777 [UIColor colorWithHex:0x777777]
