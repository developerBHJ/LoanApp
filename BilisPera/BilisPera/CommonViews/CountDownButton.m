...
- (void)setDataSource:(nullable id<CountDownButtonDataSource>)dataSource {
    if (_useBlock) {
        [self p_showError];
        return;
    }
...
- (void)setDelegate:(nullable id<CountDownButtonDelegate>)delegate {
    if (_useBlock) {
        [self p_showError];
        return;
    }
...
/** 按钮点击 */
- (void)p_buttonClicked:(CountDownButton *)sender {
    sender.enabled = NO;
