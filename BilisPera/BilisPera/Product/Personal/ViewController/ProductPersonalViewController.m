//
//  ProductPersonalViewController.m
//  BilisPera
//
...
@interface ProductPersonalViewController ()<UITableViewDelegate,UITableViewDataSource,ProductPersonalViewDelegate>

@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) ProductPersonalViewModel *viewModel;
@property (nonatomic, strong) UIButton *nextButton;

@end

@implementation ProductPersonalViewController
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    [[TrackTools shared] saveTrackTime:BPTrackRiskTypeBasicInfo start:YES];
}
...
-(void)configViewModel{
    self.viewModel = [[ProductPersonalViewModel alloc] init];
