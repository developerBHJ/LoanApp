//
//  ProductPersonalViewModel.m
//  BilisPera
//
//  Created by BHJ on 2025/8/19.
//

#import "ProductPersonalViewModel.h"

NS_ASSUME_NONNULL_BEGIN

@interface ProductPersonalViewModel ()
...
@implementation ProductPersonalViewModel
- (instancetype)init
{
    self = [super init];
    if (self) {
...
-(ProductAuthenSectionModel *)configHeaderSection{
    ProductAuthenticationHeaderViewModel *cellModel = [[ProductAuthenticationHeaderViewModel alloc] initWith:@"Personal Information" subTitle:@"For information security purposes, please provide accurate and complete information." imageName:@"icon_auth_personal"];
...
-(void)reloadData:(NSString *)productId completion:(simpleCompletion)completion{
    ...
    kWeakSelf;
    [[HttpManager shared] requestWithService:GetPersonalInfo parameters:@{@"buy":productId} showLoading:YES showMessage:NO bodyBlock:nil success:^(HttpResponse * _Nonnull response) {
